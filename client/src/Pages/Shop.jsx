            ...
            <div
              ...
              <div className="relative overflow-hidden bg-gray-100 dark:bg-gray-800">
                ...
                <button
                  ...
                  aria-label="Wishlist"
                  className={`absolute top-3 right-3 z-10 w-10 h-10 flex items-center justify-center rounded-full border backdrop-blur-md transition-all duration-300 ${ isWishlisted ? "bg-red-500 border-red-500 text-white" : "bg-white/90 dark:bg-black/40 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 hover:bg-red-500 hover:text-white hover:border-red-500" }`} >
