...
const Orders = () => {
  ...
  return (
    <div className="p-4 md:p-6 bg-gray-100 dark:bg-gray-900 min-h-screen">
      <h1 className="text-xl md:text-3xl font-bold mb-6 text-gray-800 dark:text-white">
        Orders Management
      </h1>
                ...
                {orders.map((order) => (
                  <React.Fragment key={order._id}>
                    <tr
                      ...
                      md:hover:bg-gray-50 dark:md:hover:bg-gray-700
                    "
                    >
            ...
            {orders.map((order) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-indigo-600 dark:text-indigo-400 text-sm mt-3"
                >
                  {openOrder === order._id
                    ? "Hide Details"
                    : "View Details"}
